...
export function MainAbout () {
    return (
        <main className='main'>
            ...
            <Section title={'¿Quienes somos?'} list={false}>
            ...
            <Section title={'Misión'} list={false}>
            ...
            <Section title={'Visión'} list={false}>
            ...
            <Section title={'Políticas de calidad'} list={false}>
            ...
            <Section title={'Valores institucionales'} list={true}>
